<template>
    <section class="bg-green-50">
        <div class="container m-auto max-w-2xl py-24">
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0 border-gray-300">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.type" id="type" name="type"
                            class="border rounded w-full py-2 px-3 border-gray-300" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.title" type="text" id="name" name="name"
                            class="border rounded w-full py-2 px-3 mb-2 border-gray-300"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea v-model="form.description" id="description" name="description"
                            class="border rounded w-full py-2 px-3 border-gray-300" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.location" type="text" id="location" name="location"
                            class="border rounded w-full py-2 px-3 mb-2 border-gray-300" placeholder="Company Location"
                            required />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.name" type="text" id="company" name="company"
                            class="border rounded w-full py-2 px-3 border-gray-300" placeholder="Company Name" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactEmail" type="email" id="contact_email" name="contact_email"
                            class="border rounded w-full py-2 px-3 border-gray-300"
...
export default {
    ...
    async mounted() {
        try {
            ...
            this.form.type = this.job.type;
            this.form.title = this.job.title;
            this.form.description = this.job.description;
            this.form.salary = this.job.salary;
            this.form.location = this.job.location;
            this.form.company.name = this.job.company.name;
            this.form.company.description = this.job.company.description;
            this.form.company.contactEmail = this.job.company.contactEmail;
            this.form.company.contactPhone = this.job.company.contactPhone;
        } catch (error) {
    ...
    methods: {
        async handleSubmit() {
            ...
            try {
                const response = await axios.put(`/api/jobs/${this.jobId}`, updatedJob);
